...
import com.efbiay.ubeyid.VPN.dns.DnsPacket;
import com.efbiay.ubeyid.VPN.tcpip.CommonMethods;
import com.efbiay.ubeyid.VPN.tcpip.IPHeader;
import com.efbiay.ubeyid.VPN.tcpip.TCPHeader;
import com.efbiay.ubeyid.VPN.tcpip.UDPHeader;
                    ...
                    if(tcpHeader.getSourcePort() == proxy.port){
                        ...
                        if(session.bytesSent == 0 && tcpDataSize > 10){
                            ...
                            if(host != null){
                                ...
                                Log.d("Session","No host name found: %s"+session.remoteHost);
                            }
                        }
