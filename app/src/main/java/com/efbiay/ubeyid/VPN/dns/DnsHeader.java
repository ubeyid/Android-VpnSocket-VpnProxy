package com.efbiay.ubeyid.VPN.dns;
...
public class DnsHeader {
    ...
    public static final short offset_QuestionCount = 4;
    public static final short offset_ResourceCount = 6;
    public static final short offset_AResourceCount = 8;
    public static final short offset_EResourceCount = 10;
